...
S_save  = "../Experiments/Donotlook/Surface_shaped/";
...
C_save = "../Experiments/Donotlook/Curvature_shaped/";
C_final = "../Experiments/Final/Curvature_processed/";

S_ref_name = "../Experiments/Initial/Surface_bkg_ref/Reference.jpg";
S_ref_save = "../Experiments/Donotlook/Surface_bkg_ref_shaped/Reference.jpg";

S_bkg_name = "../Experiments/Initial/Surface_bkg_ref/Background.jpg";
S_bkg_save = "../Experiments/Donotlook/Surface_bkg_ref_shaped/Background.jpg";

C_bkg_name = "../Experiments/Initial/Curvature_bkg/Background.jpg";
C_bkg_save = "../Experiments/Donotlook/Curvature_bkg_shaped/Background.jpg";
